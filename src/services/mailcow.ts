...
export function CreateMailcowRecords(target: string, certificate: string, dkimKey: string) {
    return [
        ...
        TLSA('_25._tcp', 3, 1, 1, certificate),
        TLSA('_110._tcp', 3, 1, 1, certificate),
        TLSA('_143._tcp', 3, 1, 1, certificate),
        TLSA('_443._tcp', 3, 1, 1, certificate),
        TLSA('_465._tcp', 3, 1, 1, certificate),
        TLSA('_587._tcp', 3, 1, 1, certificate),
        TLSA('_993._tcp', 3, 1, 1, certificate),
        TLSA('_995._tcp', 3, 1, 1, certificate),
        TLSA('_4190._tcp', 3, 1, 1, certificate),
