...
export const  HomelabLocalServices: Record[] = [
    ...
    /* Rancher Media Services */
    { name: 'sonarr.local', description: 'Sonarr' },
    { name: 'radarr.local', description: 'Radarr' },
    { name: 'sabnzbd.local', description: 'Sabnzbd' },
    { name: 'books.local', description: 'Calibre Web' },
];